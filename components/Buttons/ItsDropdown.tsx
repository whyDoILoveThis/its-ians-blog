    ...
    <article className="relative w-full flex justify-center items-center">
      <div className="relative">
        ...
        <div
          ...
          ref={dropdownRef}
          className={`absolute selection:bg-transparent transition-all duration-400 z-50 min-w-[8rem] rounded-md border border-white/20 bg-black bg-opacity-20 shadow-md ${
            isOpen
